...
<head>
    ...
    <link rel="icon" href="{{ asset('frontend/theme/favicon.ico') }}" type="image/x-icon">

    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/normalize.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/fontello.css') }}">
    <link href="{{ asset('frontend/theme/assets/fonts/icon-7-stroke/css/pe-icon-7-stroke.css') }}" rel="stylesheet">
    <link href="{{ asset('frontend/theme/assets/fonts/icon-7-stroke/css/helper.css') }}" rel="stylesheet">
    <link href="{{ asset('frontend/theme/css/animate.css') }}" rel="stylesheet" media="screen">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/icheck.min_all.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/price-range.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/owl.theme.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/owl.transitions.css') }}">
    <link rel="stylesheet" href="{{ asset('frontend/theme/assets/css/jquery.slitslider.css') }}">
    ...
    <noscript>
        <link rel="stylesheet" type="text/css" href="{{ asset('frontend/theme/assets/css/styleNoJS.css') }}" />
    </noscript>
</head>
...
<body>
                ...
                <div class="col-md-6 col-sm-10 col-sm-offset-1 col-md-offset-0 col-xs-12">
                    <div class="asks-first">
                        ...
                        <div class="asks-first-info">
                            ...
                            <p> varius od lio eget conseq uat blandit, lorem auglue comm lodo nisl no us nibh mas lsa
                            </p>
                        </div>
    ...
    <script src="{{ asset('frontend/theme/assets/js/modernizr-2.6.2.min.js') }}"></script>

    <script src="{{ asset('frontend/theme/assets/js/jquery-1.10.2.min.js') }}"></script>
    <script src="{{ asset('frontend/theme/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('frontend/theme/assets/js/bootstrap-select.min.js') }}"></script>
    <script src="{{ asset('frontend/theme/assets/js/bootstrap-hover-dropdown.js') }}"></script>

    <script src="{{ asset('frontend/theme/assets/js/easypiechart.min.js') }}"></script>
    <script src="{{ asset('frontend/theme/assets/js/jquery.easypiechart.min.js') }}"></script>

    <script src="{{ asset('frontend/theme/assets/js/owl.carousel.min.js') }}"></script>

    <script src="{{ asset('frontend/theme/assets/js/wow.js') }}"></script>

    <script src="{{ asset('frontend/theme/assets/js/icheck.min.js') }}"></script>
    <script src="{{ asset('frontend/theme/assets/js/price-range.js') }}"></script>


    <script src="{{ asset('frontend/theme/assets/js/jquery.ba-cond.min.js') }}"></script>
    <script src="{{ asset('frontend/theme/assets/js/jquery.slitslider.js') }}"></script>

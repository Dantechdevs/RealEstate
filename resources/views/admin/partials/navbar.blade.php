    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="languageDropdown">
          <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-ke" title="ke" id="ke"></i> <span class="ms-1"> English </span></a>
          <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-ke" title="ke" id="ke"></i> <span class="ms-1"> Kiswhahili </span></a>
        ...
        <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
          ...
          <ul class="list-unstyled p-1">
            <li class="dropdown-item py-2">
              <a href="{{ route('admin.profile.update')}}" class="text-body ms-0">
